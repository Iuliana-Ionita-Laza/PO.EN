...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const int& >::type i_iter(i_iterSEXP);
...
RcppExport SEXP _PO_EN_rcpp_hello_world() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_PO_EN_rcpp_hello_world", (DL_FUNC) &_PO_EN_rcpp_hello_world, 0},
    {NULL, NULL, 0}
};
