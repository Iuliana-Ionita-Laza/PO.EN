...
// [[Rcpp::export]]
Rcpp::List sum_compute_single_rcpp(const arma::vec &y, const arma::vec & start_beta,const arma::vec & ytx,const arma::mat & XtX_reduce,const double &lambda,const double & alpha,const arma::vec & xtx, const int & i_iter){
     double N=y.n_rows;
//  std::cout<<N<<std::endl;
